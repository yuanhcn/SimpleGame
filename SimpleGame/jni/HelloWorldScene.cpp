...
void HelloWorld::addTarget()
{
	...
	// Determine speed of the target2-2,4-40===========yuanhcn==============================================
	int minDuration = (int)(20 - _level);
	int maxDuration = (int)(40 - _level);
...
void HelloWorld::spriteMoveFinished(CCNode* sender)
{
	...
	if (sprite->getTag() == 1)  // target
	{
		...
		char str[50];
		sprintf(str, "You Lose :[ \n Level: %d.\nTotal score : %d.", _level,_totalScore);
		GameOverScene *gameOverScene = GameOverScene::create();
		gameOverScene->getLayer()->getLabel()->setString(str);
		////////////////////////////////=======//2lines//////////yuanhcn////////////////////////
...
void HelloWorld::ccTouchesEnded(CCSet* touches, CCEvent* event)
{
	...
	CCLog("++++++++after  x:%f, y:%f , _level:%d, _totalScore:%d", location.x, location.y,_level,_totalScore);
    ...
    CCARRAY_FOREACH(_projectiles, it)
	{
        ...
        CCARRAY_FOREACH(targetsToDelete, jt)
		{
			...
			if (_projectilesDestroyed >= 10)
			{
				char str[50];
				_level++;
				_totalScore = _totalScore + 10 * _level * _level;
				sprintf(str, "You Win!\n Level: %d.\nTotal score : %d.", _level,_totalScore);
